...
Simple (80%) 대상: 요약, 번역, 간단한 설명, 내부 메모 경로: Front  Ace
Standard (15%) 대상: 전략 문서, 보고서 초안, 내부 분석 경로: Front  Ace  Reviewer  Ace 수정 루프: 최대 2회 (초과 시 Critical 자동 승격)
Critical (5%) 대상: 투자자/정부 제출, 법/계약, 외부 공개 최종본 경로: Front  Researcher  Ace  Reviewer  Ace 수정  Chief 최종 승인
